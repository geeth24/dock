              ...
              {section.links.map((link) => (
                <li key={link.href} className="relative">
                  <Link
                    ...
                    onClick={onLinkClick}
                    className={clsx(
                      'before:-tranneutral-y-1/2 block w-full pl-3.5 before:pointer-events-none before:absolute before:-left-1 before:top-1/2 before:h-1.5 before:w-1.5 before:rounded-full',
                      link.href === pathname
