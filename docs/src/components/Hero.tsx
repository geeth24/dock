...
const code = `dev: docker-compose-dev.yml
prod: docker-compose-prod.yml
test: docker-compose-test.yml`

const tabs = [
  { name: '.dock', isActive: true },
  { name: 'docker-compose.yml', isActive: false },
]
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Simplify Docker Compose Workflows
              </p>
              <p className="mt-3 text-2xl tracking-tight text-neutral-400">
                Dock makes managing multiple environments effortless, with
                simple commands to control, monitor, and clean up your
                containers.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/">Get started</Button>
                <Button
                  href="https://github.com/geeth24/dock"
                  variant="secondary"
                >
                  View on GitHub
                </Button>
          ...
          <div className="relative lg:static xl:pl-10">
            <div className="absolute inset-x-[-50vw] -bottom-48 -top-32 [mask-image:linear-gradient(transparent,white,white)] lg:-bottom-32 lg:-top-32 lg:left-[calc(50%+14rem)] lg:right-0 lg:[mask-image:none] dark:[mask-image:linear-gradient(transparent,white,transparent)] lg:dark:[mask-image:linear-gradient(white,white,transparent)]">
              <HeroBackground className="-tranneutral-x-1/2 -tranneutral-y-1/2 lg:tranneutral-x-0 lg:tranneutral-y-[-60%] absolute left-1/2 top-1/2 lg:left-0" />
            </div>
            <div className="relative">
              <Image
